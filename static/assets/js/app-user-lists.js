  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      ajax: {
        url: '/users/json/',
        data: function (d) {
          d.role = $('#roleFilter').val(); // optional
        }
      },
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $role = full['role'];
            var roleBadgeObj = {
              Mahasiswa: '<i class="ri-user-line ri-22px text-success me-2"></i>',
              Dosen: '<i class="ri-vip-crown-line ri-22px text-primary me-2"></i>',
